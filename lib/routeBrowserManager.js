...
RouteBrowserManager = (function() {
  ...
  RouteBrowserManager.prototype.getRe = function(route) {
    var r;
    r = this.getRoute(route);
    return this.route.getRe(r);
  };

  RouteBrowserManager.prototype.getParameters = function(route) {
    var r;
    r = this.getRoute(route);
    return this.route.getParameters(r);
  };
